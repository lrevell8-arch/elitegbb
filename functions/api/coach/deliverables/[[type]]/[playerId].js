// Coach Deliverables Generation Endpoint
// GET /api/coach/deliverables/{type}/{playerId}
// Types: one-pager, tracking-profile, film-index
// Allows coaches to view deliverables for prospects they have access to
...
// Check if coach has access to this player (saved or in their network)
async function checkCoachAccess(env, coachId, playerId) {
  ...
  // For now, allow access to all verified players (coaches can view any verified prospect)
  // In production, you might want stricter access controls
  return true;
}
...
<body>
  ...
  <div class="contact-section">
    ...
    <div class="coach-note">
      <strong>Coach Note:</strong> Contact HWH at coaches@hoopwithher.com for a coach-to-coach referral.
    </div>
  </div>
...
<body>
  ...
  <div class="coach-actions">
    <div class="coach-actions-title">Interested in this player?</div>
    <div class="coach-actions-text">
      Contact HWH at coaches@hoopwithher.com for a coach-to-coach referral and additional information.
    </div>
  </div>

  <div class="footer">
    Elite GBB Tracking Profile • Generated ${new Date().toLocaleDateString()}<br>
    For coaching staff use • Confidential
  </div>
</body>
</html>`;
}
...
<body>
  ...
  <div class="coach-cta">
    <div class="coach-cta-title">Want more information about this player?</div>
    <div class="coach-cta-text">
      Contact HWH at coaches@hoopwithher.com for full evaluation notes and coach-to-coach referral.
    </div>
  </div>
...
export async function onRequestGet(context) {
  ...
  if (!pathMatch) {
    return new Response(
      JSON.stringify({ detail: 'Invalid URL format. Use: /api/coach/deliverables/{type}/{playerId}' }),
  ...
  try {
    ...
    if (!hasAccess) {
      return new Response(
        JSON.stringify({ detail: 'You do not have access to view this player\'s deliverables' }),
